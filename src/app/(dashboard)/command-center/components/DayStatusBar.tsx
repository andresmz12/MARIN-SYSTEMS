...
import { DAY_STATUS_CONFIG, dayStatusConfig, formatLong } from '../utils'
  ...
  return (
    <div className="sticky top-0 z-20 -mx-6 px-6 py-4 bg-zinc-900/95 backdrop-blur border-b border-zinc-800">
      <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
        {/* Date */}
        <div>
          <p className="text-[11px] uppercase tracking-widest text-zinc-500 font-semibold">Hoy</p>
        ...
        <div className="flex items-center gap-4">
          <div className="flex items-center gap-2">
            <span className="text-xs text-zinc-500 whitespace-nowrap">Horas</span>
            <input
              type="range"
              min={2}
              max={12}
