...
export default function ContentCreatorPage() {
  ...
  async function handleGenerate() {
    ...
    try {
      ...
      setToken(data.token ?? '')
      setMapaJson(data.mapaJson ?? null)
  ...
  function handleSaved(newMapa: any, newGuion: string) {
    setMapaJson(newMapa)
    setGuion(newGuion)
  }
  ...
  function handleReset() {
    setPageState('form'); setTema(''); setStudioUrl(''); setToken('')
    setMapaJson(null); setGuion(''); setCopied(false); setCopiedLink(false); setShowEdit(false)
  }
  ...
  return (
    <div className="flex flex-col items-center justify-start px-4 py-10 min-h-full">
      <div className="w-full max-w-xl">
          ...
          <div className="space-y-6">
            <div>
              ...
              <textarea value={tema} onChange={e => setTema(e.target.value)}
                ...
                className="input resize-none text-sm mt-1" rows={3}
        ...
        {/* EDIT — review & edit before opening Studio */}
        {pageState === 'edit' && (
          <div className="space-y-5">
            ...
            {!showEdit && (
              <div className="space-y-2">
                ...
                <textarea readOnly value={guion}
                  className="input resize-none text-sm leading-relaxed" rows={6} style={{ minHeight: 100 }} />
              </div>
            )}
        ...
        {pageState === 'done' && (
          <div className="space-y-6">
            ...
            <div className="space-y-3">
              ...
              <textarea readOnly value={guion} className="input resize-none text-sm leading-relaxed"
                style={{ minHeight: 120 }} rows={8} />
